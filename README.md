...
- 从当前版本开始，仓库按语义版本管理：`主版本.次版本.修订号`
- 新功能升级次版本号，例如 `v0.4.0 -> v0.5.0`
- 兼容性修复升级修订号，例如 `v0.4.0 -> v0.4.1`
- Git tag、GitHub release 标题、`CHANGELOG.md` 标题必须保持一致
- 不再出现“较新的修复版本号低于已发布功能版本”的情况

历史整理说明：

- 原 `v0.3.1` 修复版位于 `v0.4.0` 之后，现按语义版本更正为 `v0.4.1`
...
- 面向用户的变更记录统一写在 [`CHANGELOG.md`](./CHANGELOG.md)
- 发新版本前，先把待发布内容整理到 `Unreleased`
- GitHub Release notes 应与 `CHANGELOG.md` 保持一致，不要只贴 commit 列表
